            ...
            <div class="hero-card">
                <div>
                    ...
                    <div class="mt-5 flex flex-wrap gap-3">
                        <a href="{{ route('export-data') }}" class="button-primary px-5 py-2.5 inline-flex items-center gap-2 text-xs font-bold">
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                ...
                <div class="space-y-8">
                    ...
                    <div class="content-card bg-slate-50/50">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="search-ktam-input" class="form-label">Nomor Kartu KTAM</label>
                                <input id="search-ktam-input" type="text" x-model="searchKtam" placeholder="e.g. KM-20260707-0001" class="form-input">
                            </div>
                            
                            <button type="button" @click="if(searchKtam.trim()) { window.location.href = `/verify/${searchKtam.trim()}` } else { alert('Silakan masukkan nomor KTAM terlebih dahulu.') }" class="w-full button-primary flex justify-center py-2.5 text-xs">
                                ...
                                <div class="mt-2 space-y-1.5">
                                    @foreach($cats->filter(fn($c) => $c->ktamCard)->take(3) as $c)
                                        <div class="flex items-center justify-between bg-white px-3 py-1.5 rounded-lg border border-slate-200 text-xs">
                                            ...
                                            <button type="button" @click="searchKtam = '{{ $c->ktamCard->ktam_number }}'" class="text-teal-700 font-bold hover:underline text-[10px]">Pilih</button>
                                        </div>
                                    @endforeach
                                </div>
                            </div>

<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div x-data="{ showPassword: false }">
            ...
            <div class="relative">
                <input id="password" :type="showPassword ? 'text' : 'password'" class="form-input pr-10 w-full" name="password" required autocomplete="new-password" placeholder="Minimal 8 karakter" />
                <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none" aria-label="Lihat kata sandi">
        ...
        <div x-data="{ showConfirmPassword: false }">
            ...
            <div class="relative">
                <input id="password_confirmation" :type="showConfirmPassword ? 'text' : 'password'" class="form-input pr-10 w-full" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi kata sandi" />
                <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none" aria-label="Lihat konfirmasi kata sandi">
        ...
        <div>
            ...
            <div class="flex items-center gap-3">
                <div class="bg-slate-100 border border-slate-200 text-teal-800 font-mono font-bold px-3 py-2 rounded text-sm select-none tracking-widest whitespace-nowrap">

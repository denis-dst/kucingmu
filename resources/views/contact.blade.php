                        ...
                        <form action="{{ route('contact.store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name', Auth::user()?->name) }}" required placeholder="Nama Lengkap Anda" class="form-input mt-1 block w-full rounded-xl border-slate-300 text-xs py-2.5 focus:border-teal-600 focus:ring-teal-600">

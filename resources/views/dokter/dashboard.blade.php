                    ...
                    <div class="content-card">
                        ...
                        @if($queue->isEmpty())
                            <div class="text-center py-12 text-slate-500">
                                ...
                                <p class="text-xs text-slate-400 mt-1">Kucing akan masuk ke daftar ini setelah relawan melakukan check-in.</p>
                            </div>
                        @else
                            <div class="space-y-4">
                                @foreach($queue as $app)
                                    <div class="rounded-xl border border-slate-200 p-5 bg-slate-50/50 hover:bg-white hover:shadow-md transition flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        ...
                                        <div class="flex-shrink-0">
                                            <button type="button" @click="activeAppointment = {{ $app }}" class="button-primary px-4 py-2 text-xs">
                                                Mulai Periksa
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="content-card bg-slate-50/50" x-show="activeAppointment" x-transition>
                        ...
                        <form method="POST" :action="activeAppointment ? `/checkup/${activeAppointment.id}` : '#'" class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="treatment_notes" rows="2" class="form-input" placeholder="Tuliskan tindakan medis non-invasif yang diberikan..."></textarea>
                            </div>

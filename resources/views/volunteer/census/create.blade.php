                ...
                <div class="content-card space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="min-w-0">
                            ...
                            <select id="kampus" name="kampus" x-model="kampus" @change="onKampusChange()" required class="form-input text-xs w-full max-w-full truncate cursor-pointer">
                        ...
                        <div class="col-span-full min-w-0" x-data="{
                            ...
                            get currentCampusZones() {
                                const currentK = (typeof kampus !== 'undefined' ? kampus : 'UMY');
                                let baseList = [];
                                ...
                                // Gabungkan zona dari database yang relevan dengan kampus terpilih
            ...
            <div x-show="cameraModalOpen" x-transition.opacity class="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-xs flex items-center justify-center p-4" style="display: none;">
                <div class="bg-white w-full max-w-lg rounded-2xl border border-slate-200 overflow-hidden shadow-2xl space-y-4 p-5" @click.outside="closeCamera()">
                    ...
                    <div class="relative aspect-video rounded-xl bg-slate-900 overflow-hidden flex items-center justify-center border border-slate-800">
                        <video id="censusWebcamVideo" autoplay playsinline webkit-playsinline muted class="w-full h-full object-cover"></video>
    ...
    <script>
        function censusForm() {
            return {
                ...
                // Trigger when Campus is changed
                onKampusChange() {
                    this.fetchNextId();
                },
                ...
                async openCamera(slot, title) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            this.cameraLoading = false;
                            alert('Tidak dapat mengakses kamera: ' + fallbackErr.message + '. Silakan pastikan izin kamera telah diberikan di Safari atau gunakan tombol Unggah Galeri.');
                            this.closeCamera();
                        }
                    }
                },

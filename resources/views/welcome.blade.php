...
<body class="bg-slate-50 font-sans antialiased text-slate-800" x-data="{ mobileNavOpen: false }">
    ...
    <main id="main-content" tabindex="-1" class="focus:outline-none">
        ...
        @endphp
        <section id="kontak" class="py-20 bg-slate-100/70 border-t border-slate-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <!-- Unified Symmetrical Split Card -->
                <div class="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-stretch">
                    ...
                    <!-- Left Column: Rich Dark Teal Info Card (Stretches full height) -->
                    <div class="lg:col-span-5 bg-gradient-to-br from-teal-950 via-teal-900 to-emerald-950 text-white p-8 sm:p-10 flex flex-col justify-between space-y-8 relative overflow-hidden">
                        ...
                        <div class="relative z-10 space-y-3">
                            ...
                            <p class="text-xs sm:text-sm text-teal-100/80 leading-relaxed">
                                Punya pertanyaan seputar pemeriksaan kesehatan kucing, program e-Surveillance, atau ingin bermitra sebagai relawan & dokter hewan? Hubungi kami langsung.
                            </p>
                        </div>
                        ...
                        <div class="relative z-10 p-4 rounded-2xl bg-teal-950/80 border border-teal-800/60 space-y-1.5">
                            ...
                            <p class="text-[11px] text-teal-300/80 leading-relaxed">
                                Mengembangkan ekosistem ramah satwa melalui pendekatan kesejahteraan hewan berbasis nilai Islam.
                            </p>
                        </div>
                    </div>

                    <!-- Right Column: Clean Interactive Form (Stretches full height) -->
                    <div class="lg:col-span-7 p-8 sm:p-10 bg-white flex flex-col justify-between space-y-6">
                        <div>
                            <div class="border-b border-slate-100 pb-4 mb-5">
                                ...
                                <p class="text-xs text-slate-500 mt-1">Lengkapi formulir di bawah ini, tim administrator KucingMu akan merespon via email.</p>
                            </div>
